...
<div class="row">
    <div class="col-xl-3 col-lg-3">
        <div class="card box-widget widget-user ">
            <div class="widget-user-image mx-auto mt-5"><img alt="User Avatar" class="rounded-circle" style="width: 8em; height: 8em;" src="{{$avatar.'?t='.mt_rand()}}"></div>
            <div class="card-body text-center pt-2">
                <div class="pro-user">
                    <h3 class="pro-user-username text-dark mb-1 fs-22">{{$user->fname.' '.$user->lname}}</h3>
                    <h6 class="pro-user-desc text-muted"></h6>
    ...
    <div class="col-xl-6 col-lg-6">
        <div class="card">
            ...
            {{Form::open(['url' => "profile/update", 'id' => 'userForm', 'name' => 'userForm', 'class' => '','files'=>'true', 'novalidate'])}}
                <div class="card-body">
                    <div class="row">
    ...
    <div class="col-xl-3 col-lg-3">
        <div class="card">
            ...
            {{Form::open(['url' => "/change/password", 'id' => 'passForm', 'name' => 'passForm', 'class' => '','files'=>'true', 'novalidate'])}}
