...
@section('content')
        ...
        <div class="col-12">
            ...
            <div class="col-lg-12 col-md-12">
                <div  class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('trivia.updatepost')}}" id="PostForm" name="PostForm" enctype="multipart/form-data" method="post">
    {{Form::hidden('id',$posts->id,['id'=>'id','name'=>'id'])}}
    ...
    <div class="row">
        <div class="col-sm-6 col-md-3 col-xl-3 col-lg-3">
             <div class="form-group">
                 <label for="tags">Tag <span class="text-red">*</span></label>
                 <!--<select class="form-control select2-show-search" id="tag" name="tag"><option>Select Tag</option></select>-->
                  <input type="text" id="tag" name="tag" class="form-control" list="tagname" value="@if($posts->tag){{$posts->tag_name->tag}}@endif"> 
                 <datalist id="tagname">
                </datalist>
                 <span class="error"></span>
                 <input type="hidden" id="tag_id" value="{{$posts->tag}}">
             </div>
        </div>
        ...
        <div class="col-sm-12 col-md-9 col-xl-9 col-lg-9">
             <div class="form-group">
               ...
               <input type="text" class="form-control @error('question') is-invalid @enderror" name="question" id="question" placeholder="Type question here" value="@if(old('question')){{ old('question') }} @else {{$posts->question}} @endif">
               <span class="error"></span>
                @error('question')
        ...
        <input type="hidden" name="question_image_hide" value="@if($posts->question_type=='image')@if($posts->question_media!=''){{$posts->question_media}}@endif @endif">
        <input type="hidden" name="question_video_hide" value="@if($posts->question_type=='video')@if($posts->question_media!=''){{$posts->question_media}}@endif @endif">
        <input type="hidden" name="question_thumb_hide" value="@if($posts->thumbnail){{$posts->thumbnail}}@endif">
        <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
            <div class="form-group">
                ...
                <select class="form-control @error('category') is-invalid @enderror" placeholder="Select Triva Category" id="category" name="category">
                    ...
                    <option value="{{$row->id}}" @if($posts->category==$row->id){{"selected"}}@endif>{{$row->category_name}}</option>
                    @endforeach
                </select>
                <span class="error"></span>
               @error('category')
        ...
        <div class="col-sm-12 col-md-3">
            <div class="form-group">
                ...
                <div class="col-sm-8">
            <label class="radio-inline custom-control-md @error('question_type') is-invalid @enderror"> <input type="radio" @if(old('question_type')) {{(old('question_type') == "image") ? 'checked': ''}} @else @if($posts->question_type=='image') {{"checked"}} @endif @endif name="question_type" id="q_image"  value="image"> Image </label>&nbsp;&nbsp;
            <label class="radio-inline custom-control-md @error('question_type') is-invalid @enderror"> <input type="radio" @if(old('question_type')) {{(old('question_type') == "video") ? 'checked': ''}} @else @if($posts->question_type=='video') {{"checked"}} @endif @endif  name="question_type" id="q_video"  value="video"> Video </label>
            </div>
            <span class="error"></span>
               @error('question_type')
                <span class="invalid-feedback" role="alert">
        ...
        <div class="col-sm-12 col-md-5" id="q_image_div" style="display:none;">
            <div class="row">
                ...
                <div class="col-sm-4 col-md-6 mb-3">
                    <img id="question_image_img" src="@if($posts->question_type=='image')@if($posts->question_media!=''){{url($posts->question_media)}}@endif @else{{url('storage/app/public/default.png')}}@endif" alt="avatar" style="height: 100px;" />
                </div>
            </div>
        </div>
        <div class="col-sm-12 col-md-3" id="q_thumb" style="display:none;">
            <div class="row">
                ...
                <div class="col-sm-4 col-md-6 mb-3">
                    <img id="thumbnail_img" src="@if($posts->thumbnail){{url($posts->thumbnail)}} @else{{url('storage/app/public/default.png')}}@endif" alt="avatar" style="height: 100px;" />
                </div>
            </div>
        </div>
  ...
  <source src="@if($posts->question_type=='video')@if($posts->question_media!=''){{url($posts->question_media)}}@endif @endif" id="video_here">
    Your browser does not support HTML5 video.
        ...
        <div class="col-sm-12 col-md-3">
            <div class="form-group">
                ...
                <div class="col-sm-8">
            <label class="radio-inline custom-control-md @error('answer_type') is-invalid @enderror"> <input type="radio" @if(old('answer_type')){{(old('answer_type') == "text") ? 'checked': ''}} @else @if($posts->answer_type=='text') {{"checked"}} @endif @endif name="answer_type" id="ans_text"  value="text"> Text </label>&nbsp;&nbsp;
            <label class="radio-inline custom-control-md @error('answer_type') is-invalid @enderror"> <input type="radio" @if(old('answer_type')) {{(old('answer_type') == "image") ? 'checked': ''}} @else @if($posts->answer_type=='image') {{"checked"}} @endif @endif name="answer_type" id="ans_image"  value="image"> Image </label>
            </div>
            <span class="error"></span>
               @error('answer_type')
                <span class="invalid-feedback" role="alert">
        ...
        <div class="col-sm-12 col-md-9" id="ans_image_div" style="display:none;">
            <div class="row">
                ...
                <div class="col-sm-4 col-md-6 mb-3">
                    <img id="answer_image_img" src="@if($posts->answer_type=='image')@if($posts->answer_image!=''){{url($posts->answer_image)}}@endif @else{{url('storage/app/public/default.png')}}@endif" alt="avatar" style="height: 100px;" />
                </div>
            </div>
        </div>
        <div class="col-sm-12 col-md-5" id="ans_text_div" style="display:none;">
            <div class="form-group">
                ...
                <input type="text" name="answer_text" id="answer_text" class="form-control @error('answer_text') is-invalid @enderror" value="{{$posts->answer_text}}">
                <span class="error"></span>
               @error('answer_text')
                <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
        ...
        <div class="col-sm-12 col-md-3">
            <div class="form-group">
                ...
                <input type="datetime-local" name="schedule" id="schedule" @if($posts->schedule) value="{{date ('Y-m-d\TH:i:s', strtotime($posts->schedule))}}" @endif  class="form-control @error('schedule') is-invalid @enderror" >
                <span class="error"></span>
               @error('schedule')
                <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
        ...
        <div class="col-sm-12 col-md-3">
            <div class="form-group">
                ...
                <select name="status" id="status" class="form-control @error('status') is-invalid @enderror">
                    <option value="1" @if($posts->is_active==1){{"selected"}}@endif>Active</option>
                    <option value="0" @if($posts->is_active==0){{"selected"}}@endif>Inactive</option>
                </select>
                <span class="error"></span>
               @error('status')
                <span class="invalid-feedback" role="alert">
