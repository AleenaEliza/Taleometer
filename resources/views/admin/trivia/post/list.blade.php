        ...
        <div class="col-12">
            ...
            <div class="main-card mb-3 card">
                <div class="card-header">
                   <div class="col-10">
                     <div class="card-title">Trivia Post List</div>  
                   </div> 
                ...
                <div id="data_content">
                @include('admin.trivia.post.list.content')
                </div>
            </div>
            <!--/div-->
...
$(document).ready(function(){
    ...
    $("body").on("change", ".status-btn", function () {
        ...
        var url         =   '{{url("trivia/posts/updateStatus")}}';
        var smsg        =   'Post activated successfully!';
        if (sts == true){ var status = 1; }else if (sts == false){var status = 0; smsg = 'Post deactivated successfully!'; }
