    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand" href="index.html">
                <img src="{{URL::asset('admin/assets/images/brand/logo.png')}}" class="header-brand-img desktop-lgo" alt="taleometer logo">
                <img src="{{URL::asset('admin/assets/images/brand/logo1.png')}}" class="header-brand-img dark-logo" alt="taleometer logo">
                <img src="{{URL::asset('admin/assets/images/brand/favicon.png')}}" class="header-brand-img mobile-logo" alt="taleometer logo">
                <img src="{{URL::asset('admin/assets/images/brand/favicon1.png')}}" class="header-brand-img darkmobile-logo" alt="taleometer logo">
            </a>
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow  animated">
                        ...
                        <div class="notify-menu">
                            @foreach($contacts as $contact)
                                <a href="/contact-us" class="dropdown-item border-bottom d-flex pl-4">
                                    <div class="notifyimg bg-info-transparent text-info"> <i class="ti-comment-alt"></i> </div>
                                    <div>
                                        <div class="font-weight-normal1">Reach Us form from {{ $contact->user->fname; }}.</div>
                        ...
                        <div class=" text-center p-2 border-top">
                            <a href="/contact-us" class="">View All Notifications</a>
                        </div>
                    </div>
                </div>
