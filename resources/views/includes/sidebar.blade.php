...
<aside class="app-sidebar">
    <div class="app-sidebar__logo">
        <a class="header-brand" href="{{ url('/') }}">
            <img src="{{URL::asset('admin/assets/images/brand/login.png')}}" class="header-brand-img desktop-lgo" alt="Admitro logo">
            <img src="{{URL::asset('admin/assets/images/brand/logo1.png')}}" class="header-brand-img dark-logo" alt="Admitro logo">
            <img src="{{URL::asset('admin/assets/images/brand/favicon.png')}}" class="header-brand-img mobile-logo" alt="Admitro logo">
            <img src="{{URL::asset('admin/assets/images/brand/favicon1.png')}}" class="header-brand-img darkmobile-logo" alt="Admitro logo">
        </a>
    </div>
